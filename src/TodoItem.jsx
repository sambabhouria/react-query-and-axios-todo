...
const TodoItem = ({ _id, todoName, isComplete }) => {
  const { isUpdating, isErrorUpdating, errorUpdating, UpdateTodo } =
    useUpdateTodo();

  const { isDeleting, isErrorDeleting, errorDeleting, DeleteTodo } =
    useDelteTodo();
          ...
          <>
            ...
            <span>
              <input
                ...
                onChange={() => handleUpdateTodo(_id, isComplete)}
              />
              <i
